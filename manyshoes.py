...
while i != 0:
    ...
    if player == banker:
                tietot += 1
print("I THE NEVER LYING COMPUTER HAS PLAYED " + str(j) + " games")
print("Banker win total is " + str(btot))
print("Player win total is " + str(ptot))
print("Tie in the shoe total is " + str(tietot))
print("Amount of Shoes: " + str(j))
